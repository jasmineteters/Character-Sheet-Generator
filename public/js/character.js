    ...
    if ( name ) {
      const response = await fetch( '/api/character', {
        ...
        body: JSON.stringify( {
          ...
          personality_traits, ideals, bonds, flaws, attack_name_1, 
          // attack_damage_1, 
          attack_strength_1, attack_name_2, 
          // attack_damage_2, 
          attack_strength_2, attack_name_3, 
          // attack_damage_3, 
          attack_strength_3, proficiencies, equipment, features, spell_1, spell_2, spell_3, spell_4, spell_5
